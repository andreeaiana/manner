...
from manner.data.components.adressa_rec_dataset import (
    AdressaCollate,
    AdressaRecDatasetTest,
    AdressaRecDatasetTrain,
)
...
class AdressaRecDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            ...
            self.data_train = AdressaRecDatasetTrain(
                news=trainset.news,
            ...
            self.data_val = AdressaRecDatasetTest(
                news=validset.news,
                behaviors=validset.behaviors,
                max_history_length=self.hparams.max_history_length,
            )
            self.data_test = AdressaRecDatasetTest(
                news=testset.news,
