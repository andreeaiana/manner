...
from manner.data.components.mind_rec_dataset import (
    MINDCollate,
    MINDRecDatasetTest,
    MINDRecDatasetTrain,
)
...
class MINDRecDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            ...
            self.data_train = MINDRecDatasetTrain(
                news=trainset.news,
            ...
            self.data_val = MINDRecDatasetTest(
                news=validset.news,
                behaviors=validset.behaviors,
                max_history_length=self.hparams.max_history_length,
            )
            self.data_test = MINDRecDatasetTest(
                news=testset.news,
