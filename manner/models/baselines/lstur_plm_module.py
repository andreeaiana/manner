...
from manner.models.components.news_encoder import LSTURNewsEncoder as NewsEncoder
from manner.models.components.user_encoder import LSTURUserEncoder as UserEncoder


class LSTURPLMModule(LightningModule):
    def __init__(
        self,
        plm_model: str,
        ...
        self.user_encoder = UserEncoder(
            ...
            input_dim=self.hparams.text_embedding_dim + self.hparams.category_embedding_dim,
    ...
    def forward(self, batch: MINDRecBatch) -> torch.Tensor:
        ...
        user_vector = self.user_encoder(batch["users"], clicked_news_vector_agg, hist_size)
