...
from manner.models.components.news_encoder import NAMLNewsEncoder as NewsEncoder
from manner.models.components.user_encoder import MINSUserEncoder as UserEncoder


class MINSPLMModule(LightningModule):
    def __init__(
        self,
        plm_model: str,
